...
urlpatterns = [
    ...
    path('session_del',user_views.session_del,name='session_del'),
    ...
    path('new_ipaddress',admin_views.new_ipaddress,name='new_ipaddress'),
    path('forget_password',user_views.forget_password,name='forget_password'),  
    path('Admin_login',admin_views.User_admin,name='Admin_login'),   
    # path('download',user_views.download12,name='download'),
